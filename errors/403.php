...
// Current Page
$currentPage = 'Forbidden Access - 403';
...
<section class="py-5 cover-bg">
    <div class="container text-center ">
        ...
        <p>Looks like you are not allowed to access this resouce.</p>
    </div>
</section>
    ...
    <section style="min-height:40vh;" class="py-5">
        <div class="container" >
            <div>
            <p class="text-muted lead text-center">This happens when you are trying to locate a resource that is restricted</p>
